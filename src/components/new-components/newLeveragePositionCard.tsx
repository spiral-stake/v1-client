...
const NewLeveragePositionCard = ({
  ...
  return (
    <div className="bg-white bg-opacity-[4%] rounded-xl w-full flex flex-col p-[24px] gap-[24px]">
      ...
      <div className="grid grid-cols-[auto,auto] grid-rows-2 lg:grid-rows-1 lg:grid-cols-[auto,auto,auto,auto,auto]">
        ...
        <div className="col-span-1 flex flex-col gap-[8px]">
          ...
          <div className="flex items-center gap-[8px] text-[16px]">
            <p>{`${leveragePosition.collateralToken.name.slice(
              leveragePosition.collateralToken.name.length - 9,
              leveragePosition.collateralToken.name.length - 7
            )}${" "}
                  ${leveragePosition.collateralToken.name.slice(
                    leveragePosition.collateralToken.name.length - 7,
                    leveragePosition.collateralToken.name.length - 4
                  )}${" "}
                  ${leveragePosition.collateralToken.name.slice(
                    leveragePosition.collateralToken.name.length - 4,
                    leveragePosition.collateralToken.name.length
                  )}`}</p>
          </div>
        </div>
        <div className="col-span-1 flex flex-col gap-[8px]">
        ...
        <div className="hidden col-span-1 lg:flex flex-col gap-[8px]">
          <div>
            <p className="text-[14px] text-gray-400">My position</p>
          </div>
          <div className="flex items-center gap-[8px] text-[16px] truncate">
...
export default NewLeveragePositionCard;
