...
const ProductCard = ({
  ...
  return (
    <>
      {Number(apy) >= 0 && (
        <div className="group h-fit flex flex-col cursor-default w-full border-[1px] border-white border-opacity-[6%] gap-[16px] bg-white p-[16px]  rounded-xl bg-opacity-[4%] hover:bg-opacity-[10%] transition-all duration-300">
          {/* first part */}
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col gap-[4px]">
                ...
                <div className="flex items-center text-[13.4px] text-[#CCCCCC]">
                  <p>
                    {maturity} ({daysLeft(maturity)} days)
                  </p>
                  <p></p>
                </div>
              </div>
