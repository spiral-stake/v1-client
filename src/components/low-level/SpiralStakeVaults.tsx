...
const SpiralStakeVaults = () => {
  return (
    <div className="lg:w-[455px] bg-[radial-gradient(circle_400px_at_90%_240%,_rgba(0,0,255,1),_rgba(255,255,255,0.06))]
 flex gap-[8px] items-center p-[20px] rounded-[20px] border-[1px] border-[#B6B8C40F]">
      <div className="flex flex-col gap-[19px]">
        <div className="flex flex-col gap-[8px]">
          <p className="text-[16px] lg:text-[20px] font-[500]">Spiral Stake Vaults</p>
